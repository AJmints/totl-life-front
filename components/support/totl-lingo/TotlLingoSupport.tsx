    ...
    return (
        ...
        <div className='mt-4 bg-gray-800 p-3 rounded-md'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5 justify-center mx-10'>
                    <div className='bg-gray-700/80 p-3 rounded-md text-gray-300 text-base sm:text-xl xl:mx-auto'>
                    ...
                    <p>In the summer of 2023, a friend group went down the Current River in Missouri and did a 3 day float. Not an unusual activity in MO. In fact, this is a very popular recreation for many Missourians and beyond! They were goofin, and floating, and having a good time when a few of the friends of this group started dreaming of giving back to the river that creates such fond memories, a piece of MO that is truely serene. That is when the idea of Totl was born. This idea has manifested into a forum website with dreams to grow into something more.</p>
                    </div>
                </div>
            </div>
...
export default TotlLingoSupport