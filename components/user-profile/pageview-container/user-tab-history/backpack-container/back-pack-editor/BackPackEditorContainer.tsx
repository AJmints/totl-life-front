    ...
    return (
        <div className=" font-light">
            ...
            <div className="mb-2 flex gap-2 items-center">
                <div>
                    <button className="bg-gray-400 hover:bg-emerald-500 duration-200 rounded-md p-2">Add New Pack Configuration</button>
                </div>
            ...
            <div className="md:flex grid grid-cols-2 gap-2 text-gray-100">
                <h1 className="p-1 bg-slate-600 text-gray-200 rounded-md">Edit Your Packs:</h1>
