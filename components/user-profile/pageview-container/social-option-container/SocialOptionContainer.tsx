    ...
    return (
        <div className="bg-gray-500 rounded-md">
            ...
            <div className="flex space-x-2 bg-gray-400 rounded-b-none rounded-md p-2">
                ...
                <button className="bg-gray-500 hover:bg-emerald-500 duration-300 p-2 rounded-md">Trip Chats</button>
            ...
            <div className="">
                <div className="py-14 sm:px-48 bg-gray-300 rounded-md rounded-tl-none">
