...
export default function ViewBaleComments (props: ViewBaleCommentsProps) {
    ...
    return (
        ...
        <button onClick={() => props.setDetailView((prev: boolean) => !prev)} className="bg-gray-500 rounded-md px-1 hover:bg-emerald-600 duration-300 hover:px-2 hover:-mx-1 text-gray-300 hover:text-gray-800">Close</button>
        </div>
