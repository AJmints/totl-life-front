...
export default function EmptyBalesSkeleton() {
        ...
        <div className="h-screen w-auto flex justify-center">
            ...
            style={{
                ...
                <div className='bg-gray-800/40 rounded-md h-full flex  items-center justify-center'>
                    <p className='text-gray-200 font-light mx-20 sm:mx-32 md:mx-64 lg:mx-80 xl:mx-96'>Waiting for others to join this log</p>
                </div>
